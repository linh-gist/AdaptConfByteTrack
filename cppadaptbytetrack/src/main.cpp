...
int main() {
    ...
    glob("/media/ubuntu/2715608D71CBF6FC/datasets/mot/MOT16/train/MOT16-02/img1/*.jpg", img_paths, false);
    ...
    for (int frame = 0; frame < n_frames; frame++) {
        ...
        cv::Mat img = cv::imread(img_paths[frame]);
        vector<vector<float>> output_tracks = byteTracker.update(rects, img_paths[frame]);
